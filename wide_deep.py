...
class WideDeepEstimator(BaseEstimator):
    ...
    def _predict_prob(self,example_idx,wide_logit):
    ...
    def train_batch(self,features,labels):
        ...
        pred_prob=self._wide_layer.train(features,labels)

        self._dnn.backward(grads2logits=pred_prob-labels)
        return pred_prob
